            ...
            <div className="container-fluid pt-5 bg-footer">
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-md-3 col-sm-12">
                            ...
                            <div className="footer-list-div">
                                <ul>
                                    <li><a href="#">Naththandiya</a></li>
                                    <li><a href="#">Koswaththa</a></li>
                                    <li><a href="#">Kirimatiyana</a></li>
                                    <li><a href="#">Lunuwila</a></li>
                                    <li><a href="#">Wennappuwa</a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-3 col-md-3 col-sm-12">
                            <div className="footer-head-div">
                                <h5 className="text-white">Popular Catgories</h5>
                            </div>
                            <div className="footer-list-div">
                                <ul>
                ...
                <div className="container">
                    <div className="col-12 footer-copyright">
                        <p>© 2020 DRDELIVERY. All Rights Reserved. Powered By <span style={{ color: "#5bc0de", fontWeight: 700 }}>Buddhika Weerasinghe</span></p>
                    </div>
                </div>
            </div>
        );
