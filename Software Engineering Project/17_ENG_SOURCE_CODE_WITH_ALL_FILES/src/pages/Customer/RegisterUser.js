...
export default class RegisterUser extends Component {
  ...
  handleUserName(e) {
    ...
    if (userName.match(userNameFormate)) {
      ...
      this.setState({
        showError: true,
        registerFormError: "Please enter a valid name with more than 5 characters",
        userName: "",
      });
    }
  }
              ...
              <form action="javascript:void(0)">
                <div className="form-row">
                  <div className="form-group required col-md-6">
                    <label htmlFor="userFullName " className='control-label'> Name</label>
                    <input
                      type="text"
                  ...
                  <div className="form-group required col-md-6">
                    <label htmlFor="userEmail" className='control-label'>Email</label>
                    <input
                      type="email"
                      className="form-control"
                      id="userEmail"
                ...
                <div className="form-row">
                  <div className="form-group required col-md-6">
                    <label htmlFor="userNIC" className='control-label'> NIC </label>
                    <input
                      type="text"
                      className="form-control"
                      id="userNIC"
                  ...
                  <div className="form-group required col-md-6">
                    <label htmlFor="userMobile" className='control-label'>Mobile</label>
                    <input
                      type="text"
                      className="form-control"
                      id="userMobile"
                ...
                <div className="form-row">
                  <div className="form-group required col-md-6">
                    <label htmlFor="userCity" className='control-label'>City</label>
                    <input
                      type="text"
                      className="form-control"
                      id="userCity"
